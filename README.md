...
- Android 是独立原生客户端而非网页套壳：APK 内置 Go 代理核心，使用 Flutter 原生页面管理连接、节点、订阅、测速、网站测试、DNS/路由概览与流量状态，并通过系统 `VpnService` 授权框和 TUN 文件描述符接管设备流量；通用包强制包含 arm64-v8a、armeabi-v7a 与 x86_64（模拟器）核心。
